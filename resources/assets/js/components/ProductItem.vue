<template>
    ...
    <div v-show="isTypeB">
        ...
        <div class="form-group col-sm-6">
            <label>产品供应商:</label>
            <input type="text" name="supplier" class="form-control" required v-model="productSupplier">
        </div>

        <!-- Plan Field -->
        <div class="form-group col-sm-6">
            <label>计划名称:</label>
            <input type="text" name="plan" class="form-control" required v-model="productPlan">
        </div>

        <!-- Year Field -->
        <div class="form-group col-sm-6">
            <label>年期:</label>
            <input type="number" name="year" class="form-control" required v-model="productYear">
        </div>
